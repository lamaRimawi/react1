...
function Tasks() {
  ...
  clearErrors:clearEditError}=useForm({
              ...
              listFilter.map((item, index) => (
                <Card key={index} style={{ width: '18rem' }} className="me-4 mb-4 cb">
                  ...
                  <ListGroup className="list-group-flush">
                    <ListGroup.Item>Salary: ${item.salary}</ListGroup.Item>
      ...
      <Modal show={showEdit} onHide={handleCloseEdit}>
        ...
        <Modal.Body>
          <Form onSubmit={handlesubEdit(handleEdit)}>
            <FormInput id="editname" label="Name" type="text" placeholder="Edit name" registerProps={registerEdit('name')} error={editError.name} />
            <FormInput id="editdescription" label="Description" type="text" placeholder="Edit description..." registerProps={registerEdit('description')} error={editError.description} />
            <FormInput id="editsalary" label="Salary" type="number" placeholder="Edit salary..." registerProps={registerEdit('salary')}  error={editError.salary} />
            <FormInput id="editposition" label="Position" type="text" placeholder="Edit position..." registerProps={registerEdit('position')}  error={editError.position} />
            <FormInput id="editimage" label="Image URL" type="text" placeholder="Edit image URL..." registerProps={registerEdit('image')}  error={editError.image} />
             <Modal.Footer>
